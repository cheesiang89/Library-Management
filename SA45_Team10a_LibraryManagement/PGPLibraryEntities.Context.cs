...
namespace SA45_Team10a_LibraryManagement
{
    ...
    public partial class PGPLibraryEntities : DbContext
    {
        public PGPLibraryEntities()
            : base("name=PGPLibraryEntities")
        {
        }
        ...
        public virtual DbSet<BookAdjustment> BookAdjustments { get; set; }
        ...
        public virtual DbSet<BookBorrowAnalysi> BookBorrowAnalysis { get; set; }
        public virtual DbSet<BookList> BookLists { get; set; }
        public virtual DbSet<BorrowReceipt> BorrowReceipts { get; set; }
